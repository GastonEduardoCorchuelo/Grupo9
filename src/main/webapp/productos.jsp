...
<body>
	<main class="container container-form-users">
		<form class="users-form" method="post" enctype="multipart/form-data"
			...
			<div class="field1">
				<label>Elegir archivo csv:</label> <input type="file" name="archivo"
					accept=".csv, .txt">
			</div>

			<div class="botones">
				<button class="cargar" type="submit" value="enviar" name="action">Subir
					archivo</button>
			</div>

			<div class="botones">
				<a class="btn" href="ControladorProductos?action=nuevo">Agregar
					nuevo producto</a> &nbsp;&nbsp;&nbsp; <a class="btn"
					href="ControladorProductos?action=listar">Listar productos</a>
			</div>
			<p>${message}</p>
